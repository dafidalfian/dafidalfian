  ...
  <div class="container">
    ...
    <div class="row justify-content-center" style="margin-top: 5%;">
      ...
      <div class="col-lg-5">
                ...
                <div class="p-3">
                  ...
                  <input type="hidden" name="pengalihan" value="">
                    ...
                    <button class="btn btn-primary btn-block btn-user" type="submit" name="submit">
                      <i class="fa fa-lock"></i> Login dulu boss
                    </button>
        ...
        <p class="text-muted text-center mb-5" style="font-size: 25px"><small>2022 &copy; Copyright CV.ALAS. All rights reserved.</small></p>
