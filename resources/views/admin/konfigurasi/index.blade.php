...
<div class="col-md-6">
	<h3>Infformasi Perusahaan</h3><hr>
    <div class="form-group">
    ...
    <h3>Media Sosial</h3><hr>
    
    <div class="form-group">
    <label>Link Facebook <i class="fa fa-facebook"></i></label>
    <input type="text" name="facebook" placeholder="http://facebook.com/NamaFb" value="<?php echo $site->facebook ?>" class="form-control">
    </div>
    ...
    <div class="form-group">
    <label>Link Youtube <i class="fa fa-twitter"></i></label>
   <input type="text" name="twitter" placeholder="http://Youtube.com/namaYT" value="<?php echo $site->twitter ?>" class="form-control">
    </div>

    <div class="form-group">
    <label>Nama Youtube <i class="fa fa-facebook"></i></label>
    <input type="text" name="nama_twitter" placeholder="Nama Channel Youtube" value="<?php echo $site->nama_twitter ?>" class="form-control">
    </div>
    
     <div class="form-group">
    <label>Link Instagram <i class="fa fa-instagram"></i></label>
   <input type="text" name="instagram" placeholder="http://instagram.com/namaIg" value="<?php echo $site->instagram ?>" class="form-control">
    </div>
