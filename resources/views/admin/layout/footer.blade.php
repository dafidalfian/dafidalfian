...
tinymce.init({
  selector: '.konten',
  height: 500,
  content_css: 'https://achmadilandscapsejahtera.co.id/public/template/assets/vendor/bootstrap/css/bootstrap.min.css',
  ...
  toolbar: 'formatselect undo redo | fontsizeselect | bold italic strikethrough forecolor backcolor | link | alignleft aligncenter alignright alignjustify  | numlist bullist outdent indent | image | table | hr media removeformat code preview',
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Team ALAS 2022</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
