...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light bg-primary topbar mb-4 static-top shadow">
      ...
      <a href="{{ asset('admin/dasbor') }}" class="btn btn-sm text-white"><i class="fa fa-tachometer-alt"></i> Dashboard</a> 
      <a href="{{ asset('/') }}" class="btn btn-sm text-white" target="_blank"><i class="fa fa-home"></i> Beranda</a>
      <!-- Topbar Navbar -->
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
          <a class="nav-link dropdown-toggle " href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <span class="mr-2 d-none d-lg-inline text-gray-600 small"><div class="text-white"><?php echo Session()->get('nama'); ?> (<?php echo Session()->get('akses_level'); ?>)</div></span>
            <img class="img-profile rounded-circle" src="http://localhost/assets/upload/user/thumbs/testimonials-1.jpg">
          </a>
          <!-- Dropdown - User Information -->
          <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
            <a class="dropdown-item" href="http://localhost/admin/akun">
              <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
              Update Profile
            </a>
                        <a class="dropdown-item" href="http://localhost/admin/konfigurasi">
              <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>
              Setting Website
            </a>
            <a class="dropdown-item" href="http://localhost/admin/activity">
