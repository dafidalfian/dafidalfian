...
<!--Page Wrapper -->
  <div id="wrapper">
    <!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-white sidebar sidebar-success accordion" id="accordionSidebar">
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ asset('admin/dasbor') }}">
        <div class="sidebar-brand-icon">
          <img src="{{asset('public/admin/img/alas.PNG')}}" width="65" height="50" class="d-inline-block">
        </div>
      ...
      <li class="menu-header ml-2"><p>Menu Utama</p></li>
      <li class="nav-item">
      ...
      <!-- PRODUK -->
      <hr class="sidebar-divider">
      <div class="sidebar-heading">Layanan & Jasa</div>
      <hr class="sidebar-divider">
      <li class="nav-item">
        <a class="nav-link" href="{{ asset('admin/produk') }}">
          <i class="fas fa-fw fa-book"></i> <span>Semua Layanan</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{ asset('admin/produk/tambah') }}">
          <i class="fas fa-fw fa-plus"></i> <span>Tambah Layanan</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{ asset('admin/kategori_produk') }}">
          <i class="fas fa-fw fa-tags"></i> <span>Kategori Layanan</span></a>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="berita" class="collapse" aria-labelledby="berita" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item {{Request::is('admin/berita')? 'active' : ''}}" href="{{ asset('admin/berita') }}"><i class="fa fa-newspaper"></i> Data Berita</a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ asset('admin/user') }}">
          <i class="fa fa-fw fa-lock"></i> <span>User Management</span></a>
      </li>
      <!-- Konfigurasi -->
      <li class="nav-item">
