...
<div class="form-group row">
	<label class="col-sm-3 control-label text-right">Status Jadwal Layanan <span class="text-danger">*</span></label>
	<div class="col-sm-9">
...
<div class="form-group row">
	<label class="col-sm-3 control-label text-right">Lokasi Layanan <span class="text-danger">*</span></label>
	<div class="col-sm-9">
...
<div class="form-group row">
	...
	<div class="col-sm-9">
      ...
      <small class="text-gray">Misal: 22,23,26,27 Mei 2022</small>
	</div>
</div>
