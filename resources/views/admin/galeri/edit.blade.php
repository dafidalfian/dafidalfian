...
<div class="row form-group">
	...
	<div class="col-md-3">
		<select name="jenis_galeri" class="form-control">
			<option value="Masuk Galeri">Masuk Galeri</option>
			<option value="Beranda dan Galeri" 
			<?php if($galeri->jenis_galeri=="Beranda dan Galeri") { echo "selected"; } ?>
			>Beranda dan Galeri</option>
		</select>
		<small>Janis galeri</small>
	</div>
</div>
